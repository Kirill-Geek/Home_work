...
if n > x:
    print(f"Финансовый результат - прибыль. Её величина: {n - x}")
    print(f"Рентабельность выручки = {(n - x) / n}")
    c = int(input("Введите численность сотрудников "))
    print(f"Прибыль фирмы в расчете на одного сотрудника = {(n - x) / c}")
else:
    print("Финансовый результат: убыток — издержки больше выручки")